...
def main():
    ...
    # Uncomment and customize if you want to retrieve and inspect the trained model:
    # trained_model = run["model_building_step"]  # Ensure this step name matches your pipeline
